...
export class AutorizacionAsocColadaOfaPlanosComponent {
  ...
  @Input() set data(value: any) {
    console.log('En autorizacion', value)
  ...
  // ngOnInit(): void {
  //   // this.results.parametro = this._autAsocColadaOFAPlanosService.getParams()
  //   // this.backFlag_ = this._autAsocColadaOFAPlanosService.getBackFlag()
  //   // this.backFlag_ = this._autAsocColadaOFAPlanosService.getBackFlagEvalCdaP()
  //   // this.consult()
  // }
  ...
  updateFlag(): boolean {
    if (this.results.parametro.W_C_MENSA == '000') {
      return false
    } else {
      return true
    }
